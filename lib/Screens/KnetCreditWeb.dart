...
class WebviewPaymentCredit extends StatefulWidget {
  String accessToken;
  String amount;
  WebviewPaymentCredit({
    this.accessToken,
    this.amount
  });
  @override
  _WebviewPaymentCreditState createState() => _WebviewPaymentCreditState();
}

class _WebviewPaymentCreditState extends State<WebviewPaymentCredit> {
    ...
    return Material(
      child: Scaffold(
        body: WebView(
          ...
          initialUrl: 'http://15.185.204.189/webapi/payment/addcreditprepare.php?accessToken=${widget.accessToken}&amount=${widget.accessToken}',
