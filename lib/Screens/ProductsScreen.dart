      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Container(
            margin: EdgeInsets.only(
              left: SizeConfig.widthMultiplier * 21
            ),
            child: Text(
              'Products',
        ...
        body: Container(
          child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<GetProducts> snapshot){
              if(snapshot.hasData){
                        ...
                        Navigator.push(context,
                            PageTransition(
                                ...
                                child: ProductDetails(
                                  ...
                                  image: snapshot.data.data.list[index].photoUrl,
                                  price: snapshot.data.data.list[index].price,
                                  description: snapshot.data.data.list[index].descriptionShort,
                                  accessToken: widget.accessToken,
                                  productID: snapshot.data.data.list[index].idProduct,
                                )));
                      },
                      child: Container(
                        margin: EdgeInsets.only(
                          ...
                          children: [
                            Expanded(
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    child: Image.network(snapshot.data.data.list[index].photoUrl,fit: BoxFit.cover,),
                                    decoration: BoxDecoration(
